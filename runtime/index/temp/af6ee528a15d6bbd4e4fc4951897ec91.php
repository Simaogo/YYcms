<?php /*a:7:{s:39:"../template/default/article_article.htm";i:1634559952;s:5:"param";s:25:"a:1:{s:3:"aid";s:2:"78";}";s:28:"../template/default/head.htm";i:1634559396;s:30:"../template/default/banner.htm";i:1634557794;s:32:"../template/default/position.htm";i:1634558479;s:28:"../template/default/left.htm";i:1634558558;s:30:"../template/default/footer.htm";i:1634557794;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
<title><?php echo htmlentities($info['title']); ?>_<?php echo syscfg('cfg_webname'); ?></title>
<meta name="keywords" content="<?php echo htmlentities($info['keywords']); ?>" />
<meta name="description" content="<?php echo htmlentities($info['description']); ?>" />
    ...
    <div class="m_pagemenu"> 
	    <?php 
            if(isset($typeid)){
                ...
                $where[] = ["reid","=",$typeid];
                $menuList =\app\common\model\Arctype::where($where)->select();
                $menuList = $menuList ? $menuList->toArray():\think\facade\Cache::get("8406765d3267235d632bf692f1abb4d2"); 
            }else{
                $menuList = \think\facade\Cache::get("8406765d3267235d632bf692f1abb4d2");
            }
            $currid   = \think\facade\Cache::get("currid_8406765d3267235d632bf692f1abb4d2");
            foreach($menuList as $index=>$field){
                    $field["typeurl"] = \think\facade\Config::get("app.list_url")."/tid/".$field["id"];
                    $field["currentstyle"] = in_array($field["id"],$currid)?"active":"";//栏目显示高亮
            ?>
            ...
            <div class="main_r fr">
                <div class="page_content">
                    <div class="art_tit">
                        ...
                        <p> <span>来源：<?php echo htmlentities($info['source']); ?></span> <span>作者：<?php echo htmlentities($info['writer']); ?></span> <span>发布时间：<?php echo htmlentities($info['pubdate']); ?></span> <span>
                            <?php echo htmlentities($info['click']); ?>次浏览</span> </p>
                    </div>
                    <div class="art_desc">
                        <p>
                        <p><?php echo htmlentities($info['description']); ?>...</p>
                        </p>
                    </div>
                    <div class="content">
                        <?php echo $info['body']; ?>
