<?php /*a:7:{s:37:"../template/default/index_article.htm";i:1634652969;s:5:"param";s:24:"a:1:{s:3:"tid";s:1:"7";}";s:28:"../template/default/head.htm";i:1634652968;s:30:"../template/default/banner.htm";i:1634652968;s:32:"../template/default/position.htm";i:1634652970;s:28:"../template/default/left.htm";i:1634652969;s:30:"../template/default/footer.htm";i:1634652968;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
    ...
    <div class="m_pagemenu"> 
	    <?php 
            if(isset($typeid) && "son" !="top"){
                ...
                $where[] = ["reid","=",$typeid];
                $menuList =\app\common\model\Arctype::where($where)->select();
                //$menuList = $menuList ? $menuList->toArray():\think\facade\Cache::get("5efcf48acd931a4ff9fe3b42e5ea3cea"); 
            }else{
                $menuList = \think\facade\Cache::get("5efcf48acd931a4ff9fe3b42e5ea3cea");
            }
            $currid   = \think\facade\Cache::get("currid_5efcf48acd931a4ff9fe3b42e5ea3cea");
        ...
        <?php } 
            ...
            <div class="main_r fr">
                <div class="page_content">
                    <div class="page_tit">
                        <h3><?php echo htmlentities($yy['field']['typename']); ?></h3>
                    </div>
                    <div class="content"> <?php echo $yy['field']['content']; ?> </div>
                </div>
            </div>
        </div>
    </div>
