<?php /*a:7:{s:36:"../template/default/list_article.htm";i:1634558880;s:5:"param";s:24:"a:1:{s:3:"tid";s:1:"6";}";s:28:"../template/default/head.htm";i:1634559396;s:30:"../template/default/banner.htm";i:1634557794;s:32:"../template/default/position.htm";i:1634558479;s:28:"../template/default/left.htm";i:1634558558;s:30:"../template/default/footer.htm";i:1634557794;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
    ...
    <div class="m_pagemenu"> 
	    <?php 
            if(isset($typeid)){
                ...
                $where[] = ["reid","=",$typeid];
                $menuList =\app\common\model\Arctype::where($where)->select();
                $menuList = $menuList ? $menuList->toArray():\think\facade\Cache::get("e61bc63dea5239c93bb285bf3a034b85"); 
            }else{
                $menuList = \think\facade\Cache::get("e61bc63dea5239c93bb285bf3a034b85");
            }
            $currid   = \think\facade\Cache::get("currid_e61bc63dea5239c93bb285bf3a034b85");
            foreach($menuList as $index=>$field){
                    $field["typeurl"] = \think\facade\Config::get("app.list_url")."/tid/".$field["id"];
                    $field["currentstyle"] = in_array($field["id"],$currid)?"active":"";//栏目显示高亮
            ?>
    ...
    <ul class="page_menu">
        ...
        <?php } ?>
            ...
            <div class="main_r fr">
                <div class="art_list">
                    <ul>
					    <?php $list = \think\facade\Cache::get("list_tid_6_page"); foreach($list as $key =>$field) {
                   ...
                   ?>
                        <li>
                            <div class="fl"> <a href="<?php echo htmlentities($field['arcurl']); ?>"> <img src="<?php echo htmlentities($field['litpic']); ?>" alt="<?php echo htmlentities($field['title']); ?>" /> </a> </div>
                            <div class="fr"> <a href="<?php echo htmlentities($field['arcurl']); ?>"><?php echo htmlentities($field['title']); ?></a> <span><?php echo htmlentities($field['pubdate']); ?></span>
