<?php /*a:2:{s:49:"E:\WWW\tp6dedecms\app\admin\view\index\index.html";i:1637138913;s:5:"param";i:0;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="utf-8">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="lay-nav" lay-accordion="true">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd><a lay-id="<?php echo url('diyforms/index'); ?>" lay-url="<?php echo url('diyforms/index'); ?>"><cite>自定义表单</cite></a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item">
                        <a lay-id="javascript:;" lay-url="javascript:;">
