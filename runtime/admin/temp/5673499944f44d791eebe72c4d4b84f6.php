<?php /*a:4:{s:49:"E:\WWW\tp6dedecms\app\admin\view\arclist\add.html";i:1634811999;s:5:"param";s:24:"a:1:{s:2:"id";s:2:"97";}";s:51:"E:\WWW\tp6dedecms\app\admin\view\public\header.html";i:1634202730;s:51:"E:\WWW\tp6dedecms\app\admin\view\public\footer.html";i:1634222788;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
             ...
             <div class="layui-tab-item">
                <?php if(is_array($fieldset) || $fieldset instanceof \think\Collection || $fieldset instanceof \think\Paginator): $i = 0; $__LIST__ = $fieldset;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['name']!=='body'): switch($vo['type']): case "imgfile": ?>
                            <div class="layui-form-item layui-upload">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="<?php echo htmlentities($vo['name']); ?>" required  lay-verify="required" placeholder="请输入<?php echo htmlentities($vo['itemname']); ?>" autocomplete="off" class="layui-input" value="<?php echo htmlentities($vo['default']); ?>">
                                </div>
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label"><?php echo htmlentities($vo['itemname']); ?></label>
                            <div class="layui-input-block">
                              <input type="text" name="<?php echo htmlentities($vo['name']); ?>" required  lay-verify="required" placeholder="请输入<?php echo htmlentities($vo['itemname']); ?>" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    <?php endswitch; ?>
                    <?php endif; ?>
