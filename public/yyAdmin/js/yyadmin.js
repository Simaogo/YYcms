layui.define(["element", "layer"], function (exports) {
    ...
    var yyadmin = {
        tabAdd: function (o) {
            if( o.id =='javascript:;'||o.id==''||o.id=='#') return false;
            var id = o.id;
            var url = o.url;
            var title = o.title;
            if (!this.tabExist(id)) {
    ...
    $(document).on("click", "*[lay-event]", function () {
        ...
        typeof yyadmin[event] === "function" && yyadmin[event].apply(this);
    });
    ...
    $(document).ready(function () {
        if (rememberTab) {
            ...
            yyadmin.tabChange(currentTabId);
        }
    });
